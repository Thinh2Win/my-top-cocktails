...
const initialState = {
  ...
  preparation: 'enter ingredient 1 by 1 into search bar.hit enter or click add.you can then search cocktails that include the ingredients or filter cocktails by the ingredients.note the search will include all ingredients listed, not some.',
